...
complete -c notes -n '__fish_use_subcommand' -xa 'new' -d "Create a new note with given section and file name"
complete -c notes -n '__fish_use_subcommand' -xa 'list' -d "List notes with filtering by sections and/or tags with regular expressions. By default, it shows full path of notes (alias: ls)"
complete -c notes -n '__fish_use_subcommand' -xa 'ls' -d "List notes with filtering by sections and/or tags with regular expressions. By default, it shows full path of notes (alias: ls)"
complete -c notes -n '__fish_use_subcommand' -xa 'sections' -d "List all sections to stdout (alias: cats)"
complete -c notes -n '__fish_use_subcommand' -xa 'cats' -d "List all sections to stdout (alias: cats)"
...
complete -c notes -n '__fish_seen_subcommand_from ls list' -l section -d "Filter section name by regular expression"
complete -c notes -n '__fish_seen_subcommand_from ls list; and [ \'--section\' = (string split " " (commandline))[-2] ]' -xa (notes sections)
...
complete -c notes -n '__fish_seen_subcommand_from ls list' -l sort -d "Sort results by 'modified', 'created', 'filename' or 'section'. 'created' is default"
...
complete -c notes -n '__fish_seen_subcommand_from help' -xa 'new' -d "Create a new note with given section and file name"
complete -c notes -n '__fish_seen_subcommand_from help' -xa 'list' -d "List notes with filtering by sections and/or tags with regular expressions. By default, it shows full path of notes (alias: ls)"
complete -c notes -n '__fish_seen_subcommand_from help' -xa 'ls' -d "List notes with filtering by sections and/or tags with regular expressions. By default, it shows full path of notes (alias: ls)"
complete -c notes -n '__fish_seen_subcommand_from help' -xa 'sections' -d "List all sections to stdout (alias: cats)"
complete -c notes -n '__fish_seen_subcommand_from help' -xa 'cats' -d "List all sections to stdout (alias: cats)"
